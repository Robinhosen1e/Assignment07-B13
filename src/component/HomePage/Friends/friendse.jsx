...
//     return (
//         <div>
//             <div  className='p-4 rounded-lg shadow-lg border-2 border-gray-100 justify-items-center'>
...
//                         <Link href={`/friends/${friend.id}`} className='w-full text-xs text-gray-500 border border-gray-100 rounded-lg py-1.5 hover:bg-gray-50 transition-colors'>
//                             View Details
//                         </Link>
//                     </div>
//                 </div>
